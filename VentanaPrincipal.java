...
class VentanaPrincipal extends JFrame {
    ...
    public VentanaPrincipal() {
        users = new ArrayList<>();
        setTitle("Aplicación CRUD con ArrayList");
        setSize(600, 400);
    ...
    private void initComponents() {
        ...
        createButton.addActionListener(e -> crearUsuario());
    ...
    private void mostrarResultados(ArrayList<User> resultados) {
        // Crear una tabla temporal para mostrar resultados
